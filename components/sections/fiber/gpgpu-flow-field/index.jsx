...
import flowFieldFragmentShader from 'raw-loader!glslify-loader!shaders/gpgpu-flow-field/fragment.glsl'
import flowFieldParticlesShader from 'raw-loader!glslify-loader!shaders/gpgpu-flow-field/particles.glsl'
import simplexNose4d from 'raw-loader!glslify-loader!shaders/libs/simplexNoise4d.glsl'
 ...
 */
    ...
    gpgpu.particlesVariable.material.uniforms.uFlowFieldSpeed = new THREE.Uniform(0.3)
   ...
   */
    ...
    gui.add(gpgpu.particlesVariable.material.uniforms.uFlowFieldSpeed, 'value').min(0).max(4).step(0.001).name('uFlowfieldSpeed')
